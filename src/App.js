...
const GlobalStyles = () => (
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .stat-value.c-orange{color:#f97316;}.stat-value.c-yellow{color:#eab308;}.stat-value.c-green{color:#22c55e;font-size:22px;}.stat-value.c-red{color:#ef4444;}
    ...
    .data-table td{padding:14px 22px;font-size:13px;color:#c0c0d8;border-bottom:1px solid #141420;}
    ...
    .text-price{color:#22c55e;font-weight:600;font-family:'Syne',sans-serif;}
    .text-id{color:#3a3a5a;font-size:12px;}
    .fw6{font-weight:600;color:#e0e0f0;}
  `}</style>
);
            ...
            {pagina === "estoque" && (
                <div>
                  ...
                  <div className="panel-box">
                          ...
                          : estoquePag.map(item => {
                            ...
                            return (
                                <tr key={item.id} className={baixo ? "row-alert" : ""}>
                                  ...
                                  <td style={{fontWeight:600,color:baixo?"#ef4444":"#e0e0f0"}}>{item.quantidade}</td>
                    ...
                    <Paginacao atual={paginaEstoque} total={totalPE} onChange={setPaginaEstoque} />
                  </div>
                </div>
            )}
